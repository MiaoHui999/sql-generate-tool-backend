package com.wenzh.sqlGenerateTool.controller;

import com.baomidou.mybatisplus.core.conditions.query.QueryWrapper;
import com.baomidou.mybatisplus.extension.plugins.pagination.Page;
import com.google.gson.Gson;
import com.wenzh.sqlGenerateTool.common.BaseResponse;
import com.wenzh.sqlGenerateTool.common.DeleteRequest;
import com.wenzh.sqlGenerateTool.common.ErrorCode;
import com.wenzh.sqlGenerateTool.common.ResultUtils;
import com.wenzh.sqlGenerateTool.core.builder.SqlBuilder;
import com.wenzh.sqlGenerateTool.core.schema.TableSchema;
import com.wenzh.sqlGenerateTool.model.dto.TableInfoAddRequest;
import com.wenzh.sqlGenerateTool.model.dto.TableInfoQueryRequest;
import com.wenzh.sqlGenerateTool.model.dto.TableInfoUpdateRequest;
import com.wenzh.sqlGenerateTool.model.entity.TableInfo;
import com.wenzh.sqlGenerateTool.model.entity.User;
import com.wenzh.sqlGenerateTool.model.enums.ReviewStatusEnum;
import com.wenzh.sqlGenerateTool.service.TableInfoService;
import com.wenzh.sqlGenerateTool.service.UserService;
import com.wenzh.sqlGenerateTool.annotation.AuthCheck;
import com.wenzh.sqlGenerateTool.constant.CommonConstant;
...
public class TableInfoController {
    ...
    public BaseResponse<Page<TableInfo>> listMyTableInfoByPage(TableInfoQueryRequest tableInfoQueryRequest,
        ...
        tableInfoList = tableInfoList
                .stream()
                .filter(tableInfo -> tableInfo.getUserId().equals(userId)
                        || tableInfo.getReviewStatus().equals(ReviewStatusEnum.PASS.getValue()))
                .collect(Collectors.toList());
        Page<TableInfo> tableInfoPage = new Page<>(current,size);
        tableInfoPage.setTotal(tableInfoList.size());
        tableInfoPage.setRecords(tableInfoList);
        return ResultUtils.success(tableInfoPage);
    }
