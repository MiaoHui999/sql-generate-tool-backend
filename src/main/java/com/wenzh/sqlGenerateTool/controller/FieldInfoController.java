...
import com.wenzh.sqlGenerateTool.model.dto.FieldInfoAddRequest;
import com.wenzh.sqlGenerateTool.model.dto.FieldInfoQueryRequest;
import com.wenzh.sqlGenerateTool.model.dto.FieldInfoUpdateRequest;
...
import com.wenzh.sqlGenerateTool.service.FieldInfoService;
...
public class FieldInfoController {
    ...
    public BaseResponse<Page<FieldInfo>> listMyFieldInfoByPage(FieldInfoQueryRequest fieldInfoQueryRequest,
        ...
        fieldInfoList = fieldInfoList.stream()
                .filter(fieldInfo -> fieldInfo.getUserId().equals(userId)
                        || fieldInfo.getReviewStatus().equals(ReviewStatusEnum.PASS.getValue()))
                .collect(Collectors.toList());
        Page<FieldInfo> fieldInfoPage = new Page<>(current, size);
        fieldInfoPage.setRecords(fieldInfoList);
        fieldInfoPage.setTotal(fieldInfoList.size());
        return ResultUtils.success(fieldInfoPage);
    }
